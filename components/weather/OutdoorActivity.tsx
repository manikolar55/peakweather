    ...
    <div className="rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-4 shadow-sm">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
        {activities.map(({ activity, icon, rating, reason }) => (
          <div key={activity} className={`rounded-xl border p-3 flex sm:flex-col items-center sm:text-center gap-3 sm:gap-0 text-sm ${ratingColors[rating]}`}>
            <div className="text-2xl sm:mb-1 shrink-0">{icon}</div>
